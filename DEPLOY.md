...
## 3️⃣ Настроить OPENAI_API_KEY (опционально)
...
## 4️⃣ Подправить CORS (после первого деплоя)
...
## 5️⃣ Заполнить БД данными (один раз)
...
## 6️⃣ Включить Keep-Alive (чтобы не было cold start)
